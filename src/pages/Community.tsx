...
/* ── data ── */
const posts: Post[] = [
  { id: 1, category: "공지", title: "미케비치 분식집 '엄마손' 어제 오픈, 김밥 25,000동", replies: 0, time: "2시간 전", author: "운영자" },
  { id: 2, category: "공지", title: "4월 우기 시작, 우산 챙기세요", replies: 0, time: "어제", author: "운영자" },
  { id: 3, category: "공지", title: "환율 18.8동, 환전 유리한 시점", replies: 0, time: "2일 전", author: "운영자" },
  { id: 4, category: "공지", title: "한강 근처 신규 한국 마트 오픈", replies: 0, time: "03/15", author: "운영자" },
  { id: 5, category: "질문", title: "미케비치 한국 미용실 추천 좀요", replies: 3, time: "2시간 전", author: "다낭3년차" },
  { id: 6, category: "질문", title: "공항 환전 vs 시내 어디가 나아요?", replies: 7, time: "어제", author: "김수현" },
  { id: 7, category: "질문", title: "7살 아이 영어유치원 괜찮은 데 있나요?", replies: 2, time: "3일 전", author: "워킹맘" },
  { id: 8, category: "질문", title: "오토바이 렌트 안전한가요?", replies: 5, time: "4일 전", author: "개발자김" },
  { id: 9, category: "질문", title: "베트남 운전면허 발급 절차", replies: 1, time: "1주 전", author: "박은퇴" },
  { id: 10, category: "질문", title: "한강 근처 월세 50만원대 가능?", replies: 12, time: "어제", author: "이정호" },
  { id: 11, category: "질문", title: "다낭 국제학교 학비 얼마인가요", replies: 4, time: "2일 전", author: "교육맘" },
  { id: 12, category: "질문", title: "비자런 나짱 vs 방콕 비교", replies: 6, time: "3일 전", author: "비자고민" },
  { id: 13, category: "질문", title: "한국 택배 받을 수 있는 주소?", replies: 0, time: "5시간 전", author: "핵빠2인" },
  { id: 14, category: "질문", title: "다낭 치과 스케일링 가격", replies: 3, time: "6시간 전", author: "최민수" },
  { id: 15, category: "질문", title: "코워킹 스페이스 와이파이 속도 어떤가요", replies: 1, time: "1일 전", author: "개발자김" },
  { id: 16, category: "질문", title: "반려동물 데려올 수 있나요?", replies: 0, time: "5시간 전", author: "양냥이맘" },
  { id: 17, category: "질문", title: "장기체류 보험 추천", replies: 9, time: "4일 전", author: "보험고민" },
  { id: 18, category: "질문", title: "빨래방 vs 세탁기 달린 숙소", replies: 2, time: "5일 전", author: "짐줄이기" },
  { id: 19, category: "질문", title: "다낭에서 한국 넷플릭스 되나요?", replies: 3, time: "1주 전", author: "박지영" },
  { id: 20, category: "질문", title: "베트남 eSIM 통신사별 비교", replies: 7, time: "1주 전", author: "IT아저씨" },
  { id: 21, category: "질문", title: "아이 예방접종 다낭에서 가능?", replies: 1, time: "2주 전", author: "워킹맘" },
  { id: 22, category: "질문", title: "한달살기 짐 뭐 챙겨가나요", replies: 4, time: "2주 전", author: "준비중" },
  { id: 23, category: "질문", title: "우기에 서핑 가능한가요?", replies: 0, time: "3개월 전", author: "서퍼초보" },
  { id: 24, category: "정보", title: "환율 18.8동 돌파, 환전 유리한 시점", replies: 1, time: "5시간 전", author: "운영자" },
  { id: 25, category: "정보", title: "다낭 → 호이안 그랩 요금 정리", replies: 5, time: "2일 전", author: "교통정보" },
  { id: 26, category: "정보", title: "4월 다낭 축제 일정 정리", replies: 2, time: "1일 전", author: "다낭3년차" },
  { id: 27, category: "정보", title: "한강 근처 카페 5곳 정리", replies: 15, time: "02/20", author: "카페방랑" },
  { id: 28, category: "후기", title: "안투엉이 미케비치보다 조용했음", replies: 3, time: "03/14", author: "김OO", authorMeta: "30대 · 3월 한달살기" },
  { id: 29, category: "후기", title: "골프 비용 한국의 1/3 수준", replies: 8, time: "03/10", author: "이OO", authorMeta: "50대 · 2월 장기체류" },
  { id: 30, category: "후기", title: "그랩 키즈시트 없음 주의", replies: 4, time: "03/08", author: "박OO", authorMeta: "40대 · 3월 가족" },
  { id: 31, category: "후기", title: "미케비치 헬스장 3곳 비교", replies: 11, time: "02/28", author: "헬스루티너", authorMeta: "30대 · 2월 워케이션" },
  { id: 32, category: "후기", title: "3개월 체류 생활비 정산 공유", replies: 13, time: "01/15", author: "가계부맨", authorMeta: "40대 · 장기체류" },
];
      ...
      <main className="flex-1">
        ...
        <div className="mx-auto max-w-[1100px] px-4 pt-6 pb-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              size="sm"
              className="text-[15px] h-9 font-bold text-white"
                  ...
                  >
                    <div className="flex items-baseline justify-between gap-2">
                      <div className="flex items-baseline gap-1.5 min-w-0">
                        <span className={cn("text-[14px] font-extrabold shrink-0", categoryColor[post.category])}>
                          [{post.category}]
                        </span>
            ...
            <div className="hidden lg:block w-[240px] shrink-0">
              ...
              <div className="rounded" style={{ border: "1px solid #EEE" }}>
                ...
                <div className="px-3 py-2">
                  {residents.map((r, i) => (
                    <div key={i} className="py-1.5 text-[13px]" style={{ color: "#666" }}>
                      <span className="text-foreground font-semibold">{r.nickname}</span>
                      {" "}· {r.age} · {r.type}
                    </div>
                  ))}
                  <button
