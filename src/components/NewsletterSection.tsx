      ...
      <div className="container text-center">
        ...
        <div className="mt-6 max-w-md mx-auto flex items-center bg-primary-foreground/10 backdrop-blur-sm rounded-xl overflow-hidden border border-primary-foreground/20">
          <input
            type="email"
            placeholder="이메일 주소"
            className="flex-1 px-4 py-3 text-[15px] bg-transparent text-primary-foreground placeholder:text-primary-foreground/50 outline-none"
          />
          <button className="px-5 py-3 text-[15px] font-semibold bg-primary-foreground text-primary rounded-r-xl hover:bg-primary-foreground/90 transition-colors">
            무료 구독
          </button>
        </div>
      </div>
