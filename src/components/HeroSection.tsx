      ...
      <div className="container relative text-center">
        ...
        <div className="mt-6 max-w-lg mx-auto flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-white/30">
          ...
          <input
            ...
            className="flex-1 px-3 py-3 text-[15px] bg-transparent text-white outline-none placeholder:text-white/40"
          />
          <button className="px-5 py-3 text-[15px] font-semibold bg-white text-foreground hover:bg-white/90 transition-colors">
            검색
          </button>
        </div>
